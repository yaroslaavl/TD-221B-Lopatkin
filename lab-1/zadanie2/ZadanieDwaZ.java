...
public class ZadanieDwaZ {
    public static void main(String[] args) {
        ...
        XYChart chart = new XYChartBuilder().width(800).height(600).title("Wykres funkcji Z").xAxisTitle("Czas").yAxisTitle("Wartość").build();
        ...
        try {
            BitmapEncoder.saveBitmap(chart, "lab-1/zadanie2/wykresZ.png", BitmapEncoder.BitmapFormat.PNG);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
