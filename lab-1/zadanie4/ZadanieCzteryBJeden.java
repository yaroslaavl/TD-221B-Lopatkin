...
//NUNER FUNKCJI: 3
public class ZadanieCzteryBJeden {
    public static void main(String[] args) {
        ...
        for (int n = 1; n <= 1; n++) {
            ...
            b1 += gora / dol;
            tab[n] = b1;
            System.out.println("B1 " + n + ": " + b1);
        }

        XYChart chart = new XYChartBuilder().width(800).height(600).title("Wykres funkcji B1").xAxisTitle("Czas").yAxisTitle("Wartość").build();
        ...
        try {
            BitmapEncoder.saveBitmap(chart, "lab-1/zadanie4/wykresB1.png", BitmapEncoder.BitmapFormat.PNG);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
